...
\textbf{Companion work.} This work is part of a four-paper program on triadic neurosymbolic representations. The present paper's claims are evaluated independently; companion results provide additional context but are not required for the conclusions drawn here. The companion papers address the algebraic encoding formalism, a learnable projection head for language models, and an ontological framework of semantic dualities.
