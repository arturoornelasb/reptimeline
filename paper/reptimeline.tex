...
\author{Jos\'{e} Arturo Ornelas Brand\\
...
\textbf{Setup.} TriadicGPT~\citep{ornelas2026prime} is a 40M-parameter GPT that jointly learns next-token prediction and 63-bit discrete semantic projections via a triadic head trained end-to-end. reptimeline tracked 53 concepts across 8 checkpoints from step~2{,}500 to step~50{,}000.
...
\begin{table}[h]
\centering
\caption{Feature comparison. reptimeline is the only tool combining lifecycle tracking, bottom-up discovery, auto-labeling, causal verification, and backend-agnostic operation.}
...
\midrule
Per-code lifecycle & \checkmark & --- & Partial & --- & --- \\
...
Causal intervention & \checkmark & --- & --- & --- & --- \\
Backend-agnostic & \checkmark & --- & SAE & --- & LLM \\
\bottomrule
\end{tabular}
\end{table}
...
J.~A. Ornelas~Brand.
\newblock Prime factorization as a neurosymbolic bridge: Emergent algebraic semantics in generative language models.
